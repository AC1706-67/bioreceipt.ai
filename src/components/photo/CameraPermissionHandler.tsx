...
export const CameraPermissionHandler: React.FC<CameraPermissionHandlerProps> = ({
  ...
  const renderDetailedHelp = () => {
    ...
    const steps = Platform.OS === 'ios' ? [
      ...
      '2. Find "BioReceipt" in the app list',
      '3. Tap on "BioReceipt"',
      '4. Enable Camera and Photos permissions',
      '5. Return to BioReceipt and try again',
    ] : [
      '1. Tap "Open Settings" below',
      '2. Find "Apps" or "Application Manager"',
      '3. Find and tap "BioReceipt"',
      '4. Tap "Permissions"',
      '5. Enable Camera and Storage permissions',
      '6. Return to BioReceipt and try again',
    ];
...
const styles = StyleSheet.create({
  ...
  helpContainer: {
    ...
    borderRadius: BioReceiptTheme.borderRadius.md,
    borderLeftWidth: 4,
    borderLeftColor: BioReceiptTheme.colors.info,
  },
  helpTitle: {
    fontSize: BioReceiptTheme.typography.fontSize.base,
    fontWeight: '600',
